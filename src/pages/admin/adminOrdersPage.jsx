        ...
        <div className="w-full h-full overflow-y-scroll bg-gray-50 p-6 rounded-lg">
            <div className="sticky top-0 z-10 w-full min-h-[90px] rounded-2xl bg-white border border-gray-200 shadow-sm flex items-center justify-between px-6 mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage your store orders with ease</p>
                </div>
                <div className="flex items-center gap-4">
                    <span className="text-sm text-gray-600">
                        Total Orders: <span className="font-semibold tetx-gray-800">{totalOrders}</span>
                        </span>
                </div>
            </div>
                ...
                <>
                        ...
                        <table className="w-full min-w-[1200px] text-sm text-gray-700">
                            <thead className="bg-gray-100 text-gray-600">
                                <tr>
                                    ...
                                    <th className="text-left font-semibold px-5 py-4">First Name</th>
                                    <th className="text-left font-semibold px-5 py-4">Last Name</th>
                    ...
                    {/*page slection part*/}
                     <div className="w-full flex justify-end items-center gap-3 mt-4">
                            ...
                            <span className="text-sm text-gray-600">Page {currentPage} of {totalPage}</span>
                            <button 
                            onClick={
                                ()=>{
